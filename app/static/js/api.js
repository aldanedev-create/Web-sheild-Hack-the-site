...
(function() {
    ...
    class ApiClient {
        ...
        scan = {
            ...
            cancel: (scanId) => this.post('/scan/' + encodeURIComponent(scanId) + '/cancel'),
        ...
        subscription = {
            getPlans: () => this.get('/subscription/plans', false),
            getCurrent: () => this.get('/subscription/current'),
            createCheckout: (planId = 'premium') => this.post('/subscription/create-checkout', { plan_id: planId }),
            cancel: () => this.post('/subscription/cancel'),
            verifyAmazonIAP: (receipt, signature) => this.post('/subscription/amazon-iap', { receipt, signature })
        };
