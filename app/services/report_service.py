...
class ReportService:
    ...
    def export_pdf(user_id, scan_id):
        ...
        if not user.is_premium() and not user.is_admin:
            raise ValueError("PDF export is a premium feature. Please upgrade to access this feature.")
    ...
    def share_report(user_id, scan_id):
        ...
        # Check if user has premium access
        if not user.is_premium() and not user.is_admin:
            raise ValueError("Report sharing is a premium feature. Please upgrade to access this feature.")
