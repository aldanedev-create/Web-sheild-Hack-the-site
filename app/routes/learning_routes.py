...
def get_lessons():
    ...
    try:
        ...
        for lesson in lessons:
            ...
            lesson_dict['is_locked'] = lesson.is_premium and not is_premium
...
def get_lesson(lesson_id):
    ...
    try:
        ...
        if lesson.is_premium and not is_premium:
            return jsonify({
                'error': 'premium_required',
                'message': 'This lesson is available for premium users only. Please upgrade to access this content.'
            }), 403
            ...
            'results': [
                {
                    ...
                    'is_locked': r.is_premium and not is_premium
                }
                for r in results
            ]
        }), 200
