...
class User(UserMixin, db.Model):
    ...
    subscription = db.relationship('Subscription', backref='user', lazy='dynamic', cascade='all, delete-orphan')
    ...
    def is_premium(self):
        ...
        return self.plan == 'premium' or self.is_admin
    ...
    def can_scan(self):
        ...
        return self.scans_today < self._free_scan_limit()
    ...
    def get_remaining_scans(self):
        ...
        return max(0, self._free_scan_limit() - self.scans_today)
