      ...
      <div className="app-container">
        <Routes>
          ...
          <Route 
            path="/premium" 
            element={
              isAuthenticated ? <PremiumUpgrade isPremium={isPremium} onUpgrade={() => {}} /> : <Navigate to="/login" />
            } 
          />
          <Route 
            path="/settings" 
            element={
              isAuthenticated ? <Settings user={user} onLogout={handleLogout} /> : <Navigate to="/login" />
            } 
          />
