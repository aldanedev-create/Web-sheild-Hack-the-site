...
const Dashboard = ({ user, isPremium }) => {
  ...
  return (
    <div className="page-container">
      ...
      {!isPremium && (
        <div className="premium-banner">
          <div className="premium-banner-text">
            ...
            <span>Upgrade to Premium for unlimited scans, PDF reports &amp; more!</span>
          </div>
          <Link to="/premium" className="btn-premium-sm">Upgrade</Link>
        </div>
      )}
      ...
      <div className="quick-actions">
        ...
        <Link to="/premium" className="quick-action-btn">
          <i className="fas fa-crown"></i>
          <span>Upgrade</span>
        </Link>
      </div>
