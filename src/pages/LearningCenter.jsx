...
const LearningCenter = ({ isPremium }) => {
    ...
    <div className="page-container">
          ...
          lessons.map(lesson => {
            ...
            return (
              <Link
                ...
                className={`lesson-card ${lesson.is_premium ? 'premium' : ''}`}
              >
                <div>
                  ...
                  {lesson.is_premium && (
                    <span className="lesson-badge badge-premium">
                      <i className="fas fa-crown"></i> Premium
                    </span>
                  )}
                  {isLocked && (
                    <span className="locked"><i className="fas fa-lock"></i></span>
                  )}
                </div>
      ...
      {!isPremium && (
        <div className="premium-upsell">
          <p><i className="fas fa-crown" style={{ color: '#ffd700' }}></i> Premium lessons are locked. Upgrade to access advanced content!</p>
          <Link to="/premium" className="btn-premium">Upgrade Now</Link>
        </div>
      )}
    </div>
  );
