...
class Config:
    ...
    SCAN_RATE_LIMIT = _get_int('SCAN_RATE_LIMIT', 10, minimum=1)
    ...
    PREMIUM_PRICE = _get_float('PREMIUM_PRICE', 5.00, minimum=0)
    PREMIUM_CURRENCY = os.getenv('PREMIUM_CURRENCY', 'USD')
    FREE_SCAN_LIMIT = _get_int('FREE_SCAN_LIMIT', 5, minimum=0)
    PREMIUM_SCAN_LIMIT = _get_int('PREMIUM_SCAN_LIMIT', 9999, minimum=1)
    ...
    AMAZON_IAP_API_KEY = os.getenv('AMAZON_IAP_API_KEY', '')
    
    # Ad Configuration
    ADMOB_APP_ID = os.getenv('ADMOB_APP_ID', '')
    ADMOB_BANNER_ID = os.getenv('ADMOB_BANNER_ID', '')
    ADMOB_INTERSTITIAL_ID = os.getenv('ADMOB_INTERSTITIAL_ID', '')
    ADMOB_REWARDED_ID = os.getenv('ADMOB_REWARDED_ID', '')
